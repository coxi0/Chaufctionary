...
public class ClientRepository : IClientRepository
{
    ...
    {
        const string sql = "SELECT Id, Numero, Nom, Adresse, Ville, CodePostal, Telephone, Latitude, Longitude, Notes FROM Client;";
    ...
    {
        const string sql = @"SELECT Id, Numero, Nom, Adresse, Ville, CodePostal, Telephone, Latitude, Longitude, Notes
                             FROM Client
    ...
    {
        const string sql = "SELECT Id, Numero, Nom, Adresse, Ville, CodePostal, Telephone, Latitude, Longitude, Notes FROM Client WHERE Id = @Id;";
        using var connection = CreateConnection();
    ...
    {
        const string sql = @"INSERT INTO Client (Numero, Nom, Adresse, Ville, CodePostal, Telephone, Latitude, Longitude, Notes)
                             VALUES (@Numero, @Nom, @Adresse, @Ville, @CodePostal, @Telephone, @Latitude, @Longitude, @Notes);
